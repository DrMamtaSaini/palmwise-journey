...
const DetailedReportGenerator: React.FC<DetailedReportGeneratorProps> = ({
  ...
  const handleGenerateReport = async () => {
    ...
    toast.info("Generating comprehensive report", {
      description: "We're creating your professional 20+ page life report with insights on career, relationships, finances, health and more. This may take up to 1 minute.",
      duration: 5000
    });
    ...
    try {
      ...
      toast.success("Comprehensive report generated", {
        description: `Your ${report.pageCount}-page professional life report is ready to view and download.`
      });
      ...
      toast.error("Report generation failed", {
        description: "There was a problem creating your comprehensive report. Please try again later."
      });
    } finally {
    ...
    <div className="mt-6 p-6 bg-white rounded-xl shadow-soft animate-fade-in border border-[#7953F5]/10">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <h3 className="text-xl font-semibold mb-2">Comprehensive 20+ Page Palm Reading Report</h3>
          <p className="text-gray-600 mb-4">
            Get a professional 20+ page detailed report that analyzes every aspect of your life: 
            personality, career, relationships, health, wealth, life phases, spiritual growth, 
            public influence, challenges, and future predictions with personalized guidance.
          </p>
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-md p-3 mb-4 flex items-start gap-2">
            ...
            <div className="text-sm text-blue-700">
              ...
              <p>Your professional report includes practical insights, age-specific predictions, and personalized guidance for every major life area, beautifully formatted for download or printing.</p>
            </div>
          </div>
      ...
      {!isPremium && (
        <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-md text-amber-800 text-sm">
          The Comprehensive Palm Reading Report is a premium feature. Please upgrade your account to access this professional analysis.
        </div>
      )}
    </div>
  );
